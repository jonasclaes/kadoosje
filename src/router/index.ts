...
const routes: Array<RouteRecordRaw> = [
  ...
  {
    path: "/wishlists/:uniqueId/products/addProduct",
    name: "AddProduct",
    // route level code-splitting
  ...
  {
    path: "/wishlists/:uniqueId/products/:productName",
    name: "WishlistItem",
    // route level code-splitting
    // this generates a separate chunk (wishlistItem.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(
        /* webpackChunkName: "wishlistItem" */ "../views/WishlistItem.vue"
      ),
  },
];
